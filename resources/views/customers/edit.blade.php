...
<body class="min-h-screen" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <h1 class="text-white text-xl font-medium">Edit a Customer</h1>
                </div>
            </div>

            <!-- Form Card -->
            <div class="bg-white rounded-3xl p-8 shadow-xl">
                <h2 class="text-blue-600 text-2xl font-semibold mb-8 text-center">Edit Customer</h2>
    ...
    <div id="successModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 m-4 max-w-md w-full transform transition-all duration-300 scale-95">
            ...
            <h3 class="text-lg font-medium text-gray-900 text-center mb-2">Edit Customer Succesfully</h3>
